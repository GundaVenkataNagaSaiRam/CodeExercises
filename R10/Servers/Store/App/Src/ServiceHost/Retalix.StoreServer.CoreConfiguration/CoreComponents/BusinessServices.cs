        ...
        <AdvertisementCategoryLookUpService>().LifeStyle.Transient);
          ...
          <OpenAccountBalanceFindService>().LifeStyle.Transient);
           ...
           .ImplementedBy<CustomerOrderNoteModifyService>().LifeStyle.Transient);
            ...
            builder.Register(Component.For<IBusinessService>().Named("EmployeeLookupService").ImplementedBy<EmployeeLookupService>().
                      LifeStyle.Transient);

            builder.Register(Component.For<IBusinessService>().Named("EmployeeMaintenanceService").ImplementedBy<EmployeeMaintenanceService>().
                      LifeStyle.Transient);
        }
